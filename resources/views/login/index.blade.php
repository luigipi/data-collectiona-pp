 ...
 <div class="container">
    <div class="row justify-content-center ml-0 mr-0">
        <div class="col-md-5 left-col">
            ...
            <p>
                The IBOR event is here again, this year's event will taking place at the <strong>Sheraton Hotels Ikeja,</strong> by <strong>1:30pm</strong>. <br>
                Submit your details using the form to register.
            </p>
            </div>
        </div>
